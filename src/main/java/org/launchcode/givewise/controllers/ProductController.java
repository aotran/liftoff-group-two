...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> searchProductsByCharacter(@PathVariable String searchTerm) {
        List<Product> products = productService.searchProductsByCharacter(searchTerm);
        return ResponseEntity.ok(products);
    }
}
